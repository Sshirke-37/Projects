...
<div class="main">
    <div class="register">
        ...
        <form id="register" action="register.php" method="POST">
            ...
            <label>Email:</label>
            <input type="email" name="email" placeholder="Enter Valid Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="e.g., example@domain.com" required>
            ...
            <input type="password" name="pass" id="psw" maxlength="12" placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, uppercase and lowercase letter, and 8+ characters" required>
